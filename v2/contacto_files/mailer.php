...
//set the return URL
$return_url = "../contacto.php";

//set the users email address
$email = "contacto@limnotec.cl";

//array of fields in form. (In the format "field_name" => "field_label")
$form_fields = array(
"element0" => 'Tu nombre',
"element1" => 'Tu correo electrónico',
"element2" => 'Asunto',
"element3" => 'Mensaje'
);
...
$message_success = '&iexcl;Gracias! Tu mensaje ha sido recibido.';
$message_unset_fields = "Campos con * son obligatorios";
